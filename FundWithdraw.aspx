                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                              ...
                              <asp:TextBox ID="txtEndDate" runat="server" class="form-control"></asp:TextBox>
                                    ...
                                    <div class="col-md-3">
                                        Status :
                                        <asp:RadioButtonList ID="RbtStatus" runat="server" class="form-control" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                            ...
                                            <div id="gvContainer" runat="server" style="overflow: scroll; margin-top: 25px; margin-left: 25px; margin-bottom: 25px;">
                                                <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="true" GridLines="Both" class="table table-bordered" HeaderStyle-CssClass="bg-primary"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="TDS Charge" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblTdsAmount" runat="server" Text='<%# Eval("TdsAmount") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Service Charge" Visible="false">
                                                            <ItemTemplate>
