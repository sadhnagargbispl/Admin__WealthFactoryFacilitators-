<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PayoutReport.aspx.cs" Inherits="PayoutReport" %>
                 ...
                 <div class="col-12">
                     <div class="card card-primary">
                         <div class="card-header">
                             <h3 class="card-title">Binary Income Detail</h3>
                         </div>
                         <div class="card-body">
                             <div class="row">
                                 <div class="col-md-2">
                                                 ...
                                                 <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="false" AllowPaging="true" CssClass="table table-bordered"
                                                     ...
                                                     <Columns>
                                                      ...
                                                      <asp:TemplateField HeaderText="Referral Name" SortExpression="Referral_Name">
                                                         ...
                                                         <asp:TemplateField HeaderText="Referral Income" SortExpression="Referral Income">
                                                             <ItemTemplate>
                                                                 <asp:Label ID="lblBV" runat="server" Text='<%# Eval("Referral Income") %>'></asp:Label><br />
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Daily CashBack" SortExpression="Daily CashBack">
                                                          <ItemTemplate>
                                                              <asp:Label ID="lblDaily" runat="server" Text='<%# Eval("Daily CashBack") %>'></asp:Label><br />
                                                          </ItemTemplate>
                                                      </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Binary Income" SortExpression="Binary Income">
                                                             <ItemTemplate>
                                                                 <asp:Label ID="lblIncome" runat="server" Text='<%# Eval("Binary Income") %>'></asp:Label><br />
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                     </Columns>
                                                 </asp:GridView>
