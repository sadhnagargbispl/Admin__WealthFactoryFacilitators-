<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BinaryDirectReport.aspx.cs" Inherits="BinaryDirectReport" %>
                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Binary Direct Report</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <asp:Button ID="AddLevel" runat="server" class="btn btn-primary" Text="Binary Direct" OnClick="AddLevel_Click" />
                                    </div>
                                </div>
