<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RegistartionPoolReport.aspx.cs" Inherits="RegistartionPoolReport" %>
                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Registration Pool Report</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <asp:DropDownList ID="DdlStatus" runat="server" class="form-control"
                                            ...
                                            <asp:ListItem Value="Z">--Select Status--</asp:ListItem>
                                            <asp:ListItem Value="Achieve">Achieve</asp:ListItem>
                                            ...
                                            <ContentTemplate>
                                                <div id="gvContainer" runat="server" class="table table-bordered" style="overflow: scroll">
                                                    ...
                                                    <asp:GridView ID="GvData1" runat="server" AutoGenerateColumns="true" AllowPaging="true" CssClass="table table-bordered"
                                                        HeaderStyle-CssClass="bg-primary" PageSize="15" EmptyDataText="No data to display." OnPageIndexChanging="GrdTotal1_PageIndexChanging">
                                                        <Columns>
