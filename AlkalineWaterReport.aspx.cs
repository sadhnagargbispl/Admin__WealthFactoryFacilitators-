...
using Irony.Parsing;
public partial class AlkalineWaterReport : System.Web.UI.Page
{
    string scrname;
    ...
    public void BindData()
    {
        try
        {
            ...
            string sql = "exec sp_GetAlkalineWaterReport '" + ID + "','" + startDate + "', '" + endDate + "','N'";
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable Dt_GetApi = new DataTable();
            string sql = "exec sp_GetAlkalineWaterReport '" + ID + "','" + startDate + "', '" + endDate + "','Y'";
            Dt_GetApi = SqlHelper.ExecuteDataset(constr1, CommandType.Text, sql).Tables[0];
    ...
    private void ExportExcel()
    {
        try
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=AlkalineWaterReport.xlsx");
    ...
    protected void btnConfirm_Click(object sender, EventArgs e)
    {
        ...
        foreach (DataRow row in dtExcelData.Rows)
        {
            ...
            {
                string sql = "select * from " + objDAL.DBName + "..AlkalineWaterJug where cardno = '" + row["CardNo"].ToString().Replace("'", "") + "'";
                Dt_GetApi = SqlHelper.ExecuteDataset(constr1, CommandType.Text, sql).Tables[0];
                ...
                {
                    string Sql = "Update AlkalineWaterJug set CardNo = '" + row["CardNo"].ToString().Replace("'", "") + "',CourierName = '" + row["CourierName"] + "',";
