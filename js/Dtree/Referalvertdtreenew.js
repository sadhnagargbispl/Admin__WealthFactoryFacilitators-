...
function Node(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, idstatus, DirctLeftActive, DirectRightActive, Directbv, InDirectbv,	investment, UpgradeDate, slab) {
	this.id = id;
	this.pid = pid;
	this.name = name;
	this.url = url;
...
dTree.prototype.add = function (id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, idstatus, DirctLeftActive, DirectRightActive, Directbv, InDirectbv, investment, UpgradeDate, slab) {
	this.aNodes[this.aNodes.length] = new Node(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, idstatus, DirctLeftActive, DirectRightActive, Directbv, InDirectbv, investment, UpgradeDate, slab);
};
...
dTree.prototype.node = function (node, nodeId) {
	...
	if (this.config.useIcons) {
		...
		strTable += '</tr>';
		strTable += '<tr>';
		strTable += '<td bgcolor=#277AB1><font color=#FFFFFF FACE=Verdana SIZE=1><strong>Level Percentage </strong></font></td>';
		strTable += '<td><font FACE=Verdana SIZE=1>' + node.slab + '</font></td>';
		strTable += '</tr>';
		strTable += '<tr>';
		...
		strTable += '<td><font FACE=Verdana SIZE=1>Direct :' + node.Directbv + ', Indirect :' + node.InDirectbv + '</font> </td>';
		strTable += '</tr>';

		strTable += '<tr>';
		strTable += '<td bgcolor=#277AB1><font color=#FFFFFF FACE=Verdana SIZE=1><strong>Investment</strong></font></td>';
		strTable += '<td><font FACE=Verdana SIZE=1>' + node.investment + '&nbsp;</td>';
		strTable += '</tr>';
		strTable += '<tr>';
