...
public partial class PayoutReport : System.Web.UI.Page
{
    ...
    public void BindData(int PageIndex)
    {
        ...
        try
        {
            ...
            Ds = SqlHelper.ExecuteDataset(constr, "sp_GetPayoutIncome_new", prms);
            //Ds = SqlHelper.ExecuteDataset(constr, "sp_GetPayoutIncome", prms);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            prms[6] = new SqlParameter("@RecordCount", SqlDbType.Int);
            prms[6].Direction = ParameterDirection.Output;
            Ds = SqlHelper.ExecuteDataset(constr, "sp_GetBinaryIncomeDetail", prms);
    ...
    private void ExportExcel()
    {
        try
        {
            ...
            {
                wb.Worksheets.Add(dt, "BinaryIncomeDetail");
                Response.Clear();
                Response.Buffer = true;
                Response.Charset = "";
                Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                Response.AddHeader("content-disposition", "attachment;filename=BinaryIncomeDetail.xlsx");
