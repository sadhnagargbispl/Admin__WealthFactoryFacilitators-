<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MagicbonusReport.aspx.cs" Inherits="MagicbonusReport" %>
                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Magic Income Report</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2">
                                                ...
                                                <div id="gvContainer" runat="server" class="table table-bordered" style="overflow: scroll">
                                                    ...
                                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="false" AllowPaging="true" CssClass="table table-bordered"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Magic Income" SortExpression="Comm">
                                                                <ItemTemplate>
