<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PetroCartReport.aspx.cs" Inherits="PetroCartReport" %>
                    ...
                    <div class="col-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Petro Card Purchase Report</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3">
                                                    ...
                                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="false" AllowPaging="true" CssClass="table table-bordered"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Update" HeaderStyle-Width="55px" ItemStyle-HorizontalAlign="Center" ControlStyle-CssClass="btn-group">
                                                                <ItemTemplate>
                                                                    <a href='<%# "UpdatePetroCard.aspx?petroid=" + HttpUtility.UrlEncode(Crypto.Encrypt(Eval("id").ToString())) %>' class="btn btn-primary ">Update</a>
                                                                </ItemTemplate>
