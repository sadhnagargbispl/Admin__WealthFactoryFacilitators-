...
public partial class DailyBonusReport : System.Web.UI.Page
{
    ...
    public void BindData(int PageIndex)
    {
        ...
        try
        {
            ...
            Ds = SqlHelper.ExecuteDataset(constr1, "sp_GetDailyBonusReportDetail", prms);
    ...
    private void ExportExcel()
    {
        try
        {
            ...
            {
                wb.Worksheets.Add(dt, "DailyBounsReport");
                Response.Clear();
                Response.Buffer = true;
                Response.Charset = "";
                Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                Response.AddHeader("content-disposition", "attachment;filename=DailyBounsReport.xlsx");
