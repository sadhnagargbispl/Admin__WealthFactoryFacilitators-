                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group" id="divSingle" runat="server">
                                          ...
                                          <asp:TextBox class="form-control" ID="txtMemberId" runat="server" OnTextChanged="txtMemberId_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            ...
                                            <asp:Label ID="LblMemberName" runat="server" ForeColor="Green"></asp:Label>
                                            <asp:Label ID="LblKitid" runat="server" Visible="false"></asp:Label>
                                        </div>
                                        <div class="form-group" id="div1" runat="server">
                                            Bill No. *
                                          <asp:TextBox class="form-control" ID="TxtBillNo" runat="server" AutoPostBack="true" OnTextChanged="TxtBillNo_TextChanged"></asp:TextBox>
                                        </div>
