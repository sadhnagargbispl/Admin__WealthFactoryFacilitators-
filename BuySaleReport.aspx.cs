...
public partial class BuySaleReport : System.Web.UI.Page
{
    ...
    protected void DeleteGroup(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Key", "alert('Something Went Wrong.');location.replace('BuySaleReport.aspx');", true);
            }
        }
        catch (Exception ex)
        {
