<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BinaryIncome.aspx.cs" Inherits="BinaryIncome" %>
                                                    ...
                                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="false" AllowPaging="true" CssClass="table table-bordered"
                                                        ...
                                                        <Columns>
                                                         ...
                                                         <asp:TemplateField HeaderText="Referral Name" SortExpression="Referral_Name">
                                                            ...
                                                            <asp:TemplateField HeaderText="Macthed BV" SortExpression="BV">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Binary Income" SortExpression="Commission">
                                                                <ItemTemplate>
