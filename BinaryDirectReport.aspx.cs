...
public partial class BinaryDirectReport : System.Web.UI.Page
{
    DAL objDAL = new DAL();
    ...
    public void BindData()
    {
        ...
        try
        {
            ...
            qry1 = objDAL.IsoStart + "exec Sp_GetDataBinaryDirect '" + Idno.ToString() + "'" + objDAL.IsoEnd;
    ...
    protected void AddLevel_Click(object sender, EventArgs e)
    {
        try
        {
            Response.Redirect("AddBinaryDirect.aspx", false);
        }
        catch (Exception Ex)
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertMessage", "alert('" + Ex.Message + "')", true);
