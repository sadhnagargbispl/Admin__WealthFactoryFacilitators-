...
public partial class profile : System.Web.UI.Page
{
    ...
    private void FillDetail()
    {
        ...
        try
        {
            ...
            if (Dt.Rows.Count > 0)
            {
                ...
                ViewState["PreviousValue"] = TxtCoinAddress.Text;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string previousValue = ViewState["PreviousValue"].ToString(); // Pehli wali value
            string currentValue = TxtCoinAddress.Text; // Abhi jo user ne enter ki hai
