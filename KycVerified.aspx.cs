    ...
    public void BindData(string Condition = "")
    {
        try
        {
            ...
            sql = "select Cast(a.FormNo as varchar) as FormNo, Replace(CONVERT(varchar, a.Doj, 106), ' ', '-') as Doj, " +
                  ...
                  "CASE WHEN c.BackAddressProof<>'' then c.BackAddressProof else 'http://wpuser.cryptpayapi.com/Images/no_photo.jpg' end as BackAdressProof, " +
                  ...
                  "CASE WHEN c.AddrProof <>'' Then c.AddrProof ELSE 'http://wpuser.cryptpayapi.com/Images/no_photo.jpg' END AddressproofStatus, " +
                  ...
                  "CASE WHEN c.BankProof <>'' Then c.BankProof ELSE 'http://wpuser.cryptpayapi.com/Images/no_photo.jpg' END AS BankProofStatus, " +
