...
public partial class WalletReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string str = objDAL.IsoStart + " exec sp_GetWalletBalanceDetailDigital '" + Idno.ToLower() + "','1',10,'Y','" + txtStartDate.Text + "', '" + txtEndDate.Text + "',0" + objDAL.IsoEnd;
    ...
    public void BindData(int PageIndex)
    {
        try
        {
            ...
            string str = objDAL.IsoStart + " exec sp_GetWalletBalanceDetailDigital '" + Convert.ToString(Idno).ToLower() + "','" + PageIndex + "',10,'N','" + txtStartDate.Text + "', '" + txtEndDate.Text + "',0" + objDAL.IsoEnd;
            Ds = SqlHelper.ExecuteDataset(constr1, CommandType.Text, str);
            ...
            //int LabelPointNew = Convert.ToInt32(Ds.Tables[2].Rows[0]["PointWalletBal1New"]);
