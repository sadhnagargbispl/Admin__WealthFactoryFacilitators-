...
partial class img : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (Request["Type"] != null)
        {
            ...
            {
                sql = "select case When ScannedFile='' then 'http://digitaldealss.com/Images/no_photo.jpg' else 'http://digitaldealss.com/images/UploadImage/'+ ScannedFile" + " end as ImageLnk1 from WalletReq  where Reqno='" + Request["ID"] + "'";
                dt = new DataTable();
                //obj = new DAL();
                //dt = obj.GetData(sql);
                dt = new DataTable();
            ...
            {
                sql = "select case When Imgpath='' then 'http://digitaldealss.com/Images/no_photo.jpg' else 'http://digitaldealss.com/images/UploadImage/'+ ImgPath" + " end as ImageLnk1 from TrnPinReqMain  where Reqno='" + Request["ID"] + "'";
                dt = new DataTable();
                //obj = new DAL();
                //dt = obj.GetData(sql);
                dt = new DataTable();
            ...
            {
                sql = "select case When BackAddressProof='' then 'http://digitaldealss.com/Images/no_photo.jpg' else BackAddressProof" + " end as ImageLnk1 from KycVerify  where Formno='" + Request["ID"] + "'";
                dt = new DataTable();
                //obj = new DAL();
                //dt = obj.GetData(sql);
                dt = new DataTable();
            ...
            {
                sql = "select case When AddrProof='' then 'http://digitaldealss.com/Images/no_photo.jpg' else AddrProof" + " end as ImageLnk1 from KycVerify  where Formno='" + Request["ID"] + "'";
                dt = new DataTable();
                //obj = new DAL();
                //dt = obj.GetData(sql);
                dt = new DataTable();
            ...
            {
                sql = "select case When BankProof='' then 'http://digitaldealss.com/Images/no_photo.jpg' else BankProof" + " end as ImageLnk1 from KycVerify  where Formno='" + Request["ID"] + "'";
                dt = new DataTable();
                //obj = new DAL();
                //dt = obj.GetData(sql);
                dt = new DataTable();
            ...
            {
                sql = "select case When PanImg='' then 'http://digitaldealss.com/Images/no_photo.jpg' else PanImg" + " end as ImageLnk1 from KycVerify  where Formno='" + Request["ID"] + "'";
                dt = new DataTable();
                //obj = new DAL();
                //dt = obj.GetData(sql);
                dt = new DataTable();
