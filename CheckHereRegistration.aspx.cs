...
public partial class CheckHereRegistration : System.Web.UI.Page
{
    DAL objDAL = new DAL();
    ...
    public void BindData(int PageIndex)
    {
        ...
        try
        {
            ...
            email = TxtEmailID.Text != "" ? TxtEmailID.Text : "";
            GvData1.DataSource = null;
            GvData1.DataBind();
            SqlParameter[] prms = new SqlParameter[8];
            prms[0] = new SqlParameter("@IDNo", Idno.ToLower());
            prms[1] = new SqlParameter("@EmailID", email.ToLower());
            prms[2] = new SqlParameter("@FromSessid", FromSessid);
            prms[3] = new SqlParameter("@ToSessid", ToSessid);
            prms[4] = new SqlParameter("@PageIndex", PageIndex);
            prms[5] = new SqlParameter("@PageSize", 1000000);
            prms[6] = new SqlParameter("@IsExport", "N");
            prms[7] = new SqlParameter("@RecordCount", ParameterDirection.Output)
            { Direction = ParameterDirection.Output };
            Ds = SqlHelper.ExecuteDataset(constr1, "sp_GetClickHereInvestmentDetail_", prms);
    ...
    private void ExportExcel()
    {
        try
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=QueryRequestReport.xlsx");
